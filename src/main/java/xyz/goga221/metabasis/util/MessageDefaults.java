...
final class MessageDefaults {
    ...
    static final Map<String, String> ALL = Map.ofEntries(
            ...
            Map.entry("warp.create.exists", "<red>A warp named <white><name></white> already exists. Use <white>/warp move <name></white> to relocate it, or pick a different name.</red>"),
            Map.entry("warp.create.success", "<green>Warp <white><name></white> created.</green>"),
            Map.entry("warp.create.failed", "<red>Failed to save warp <white><name></white>.</red>"),
            Map.entry("warp.move.success", "<green>Warp <white><name></white> moved to your location.</green>"),
            Map.entry("warp.move.failed", "<red>Failed to move warp <white><name></white>.</red>"),
            ...
            Map.entry("warp.list.filter-empty", "<yellow>No warps found for group <white><name></white>.</yellow>"),
            Map.entry("warp.list.invalid-page", "<red>Page <white><page></white> doesn't exist — there are only <white><pages></white> page(s).</red>"),
            Map.entry("warp.list.page-header", "<gold>Warps</gold> <gray>(page <white><page></white>/<white><pages></white>)</gray>"),
            Map.entry("warp.list.group-header", "<dark_gray>── <white><group></white> ──</dark_gray>"),
            Map.entry("warp.list.entry", "  <gray>•</gray> <white><name></white><suffix>"),
            Map.entry("warp.list.footer", "<gray>Tip: <white>/warp list <page></white> for more, or <white>/warp list group <name></white> to filter.</gray>"),
